...
def title():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Copyright : Nguyễn Nhật Quyền (TeamLion)    "+Fore.LIGHTGREEN_EX  +" ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Zalo Contact : 0792161421  "+Fore.LIGHTGREEN_EX  +"                  ║\n")
